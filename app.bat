...
:: Download cmdline-tools using Start-BitsTransfer (shows progress bar and is fast)
powershell -Command "Start-BitsTransfer -Source 'https://dl.google.com/android/repository/commandlinetools-win-11076708_latest.zip' -Destination '%SDK_DIR%\tools.zip'"
