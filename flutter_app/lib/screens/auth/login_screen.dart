  ...
  void _submit() async {
    if (_emailController.text.trim().isEmpty || _passwordController.text.trim().isEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(lang.translate("Please fill all fields"))),
      );
      return;
    }
    ...
    if (_isSignUp) {
      ...
      if (error == null) {
        ...
        final lang = Provider.of<LanguageProvider>(context, listen: false);
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(lang.translate("Registration successful! Please login."))),
        );
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            _isSignUp
                                ? lang.translate("Join our green community")
